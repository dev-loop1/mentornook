...
SECRET_KEY = 'django-insecure-=YOUR_SECRET_KEY_HERE' # Replace with your key

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True # Set to False for production

ALLOWED_HOSTS = [] # Add your frontend domain and backend domain in production
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mentornook_db', # Replace with your DB name
        'USER': 'vikas', # Replace with your DB user
        'PASSWORD': 'vikku', # Replace with your DB password
...
CORS_ALLOWED_ORIGINS = [
    # Add the origin of your frontend (e.g., where index.html is served)
